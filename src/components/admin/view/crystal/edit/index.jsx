...
export default class Edit extends Component {
    ...
    handleSubmit = event => {
        ...
        swal({
            title: "Are you sure?",
            text: "You want to Update Crystal",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
        ...
        return (
            <div className="container-fluid">
                ...
                <ol className="breadcrumb mb-30">
                    ...
                    <li className="breadcrumb-item"><a href="#/admin/crystal/create">Crystals</a></li>
                    <li className="breadcrumb-item active">Update Crystal</li>
                </ol>
